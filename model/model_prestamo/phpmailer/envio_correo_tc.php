...
// Subir Archivo
@mkdir("../../../views/view_tarjeta_credito/adjuntos_correo/".$No_Req."", 0700);
...
$directorio_destino = "../../../views/view_tarjeta_credito/adjuntos_correo/".$No_Req."/";
...
// Subimos la imagen
    ...
    move_uploaded_file($tmp_name, "../../../views/view_tarjeta_credito/adjuntos_correo/".$No_Req."/".$file_name);
}
...
$archivo = '../../../views/view_tarjeta_credito/adjuntos_correo/'.$No_Req.'/'.$file_name;
...
try {
    ...
    $mail->isHTML(true);
    /*Obteniendo el numero de la requisa*/
    $query = "
    select
      com_no_solicitud as soli
    FROm
      com_solicitud_tarjeta_credito
    WHERE
      com_solicitud='$No_Req'";
    ...
    $mail->Subject='Correo Tarjeta Credito No.'.$soli.'';
