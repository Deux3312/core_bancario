...
// Subir Archivo
@mkdir("../../../views/view_flota/adjuntos_correo/".$No_Req."", 0700);
...
$directorio_destino = "../../../views/view_flota/adjuntos_correo/".$No_Req."/";
...
// Subimos la imagen
    ...
    move_uploaded_file($tmp_name, "../../../views/view_flota/adjuntos_correo/".$No_Req."/".$file_name);
}
...
$archivo = '../../../views/view_flota/adjuntos_correo/'.$No_Req.'/'.$file_name;
...
try {
    ...
    $mail->Subject='Correo Tarjeta Flota No.'.$soli.'';
